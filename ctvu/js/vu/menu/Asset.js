vu.menu.Asset = CT.Class({
	...
	_: {
		ones: ["bg7.jpg", "bgBITZs4a.jpg", "bg_yan3.jpg", "bod.jpg", "bunny_ears.jpg", "bunny_teeth.jpg", "eye_brown_basic.jpg", "graph_paper.jpg", "hair_alphaGimp3_2SMALL.png", "hair_alphaGimp3a.png", "hairC5dHat.png", "hair.png", "hairShrunk.png", "head.jpg", "head_UV2.jpg", "icon.jpg", "room1.jpg", "shirt.jpg", "teeth256s.jpg", "white.jpg"],
		textures: {},
		sel: function(target) {
			var _ = this._;
			return function() {
				CT.modal.prompt({
					...
					data: _.ones.map(function(o) { return "/maps/one/" + o; }),
					cb: function(tx) {
