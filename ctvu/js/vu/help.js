vu.help = {
	sections: {
        ...
        adventure: "Move your character around with WASDZC. Jump with SPACE. Run with SHIFT. Open doors with ENTER or X. Adjust the camera with QERF and the ARROW keys. Click a person or object to interact. Basic (most useful) camera controls in bottom-right corner.",
        arcraft: "Design augmented reality experiences!",
        chat: "Catch up with your buds!"
	},
	general: {
		navigation: "Use the W, A, S, and D keys to move your avatar. Rotate with Z and C. Press SPACE to jump. Hold SHIFT to run. Press ENTER or X to enter a portal.",
