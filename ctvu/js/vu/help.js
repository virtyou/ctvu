vu.help = {
	sections: {
        ...
        adventure: "Move your character around with WASDZC. Jump with SPACE. Run with SHIFT. Open doors with ENTER or X. Adjust the camera with QERF and the ARROW keys. Move your arms and legs with OPEN_BRACKET and CLOSE_BRACKET and SEMICOLON and QUOTE. Click a person or object to interact. Basic (most useful) camera controls in bottom-right corner.",
