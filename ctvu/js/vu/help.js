vu.help = {
	sections: {
        ...
        play: "Walk around the world on the explore page, and hang out with the other players. Move your avatar with WASD, press SPACE to jump, and hold SHIFT to run. Press ENTER to walk through a door, and jump out of fire to fly. Click any person or most things to pull up an interactive menu - use this to chat with an automaton, read a book, etc. Switch between cameras with the Camera menu at the top of the screen (the behind cam is best for navigation), and use the arrow keys for finer-grained camera control. The basic (test page) menus are at the bottom of the page: Triggers and Vibes, bottom left; Gestures, Dances, and Mods, bottom right. Also included are the Map at the top right, the Chat menu at the bottom and the Run Home button at the top (only visible when you're away from your home room). If you have any questions, click the 'help!' button or say 'enable help mode' while chatting with any automaton. Anything you say or do is relayed to anyone else nearby, so play responsibly!",
	...
	general: {
		navigation: "Use the W, A, S, and D keys to move your avatar. Press SPACE to jump. Hold SHIFT to run. Press ENTER to enter a portal.",
		cameras: "Use the camera menu at the top of the page to switch between pov, behind, front, and numbered room cameras. The arrow keys either cycle between room cameras or (for pov, behind, and front cameras) gently tilt your avatar's neck, thereby moving the camera. Navigation is easiest with the behind camera.",
