vu.help = {
	sections: {
        ...
        adventure: "Move your character around with WASDZC. Jump with SPACE. Run with SHIFT. Open doors and pick up items with ENTER or X. Adjust the camera with QERFTGPB or the ARROW keys. Move your arms and legs with OPEN_BRACKET and CLOSE_BRACKET and SEMICOLON and QUOTE, and use -=_+ to swap items. Click a person or object to interact. Basic (most useful) camera controls in bottom-right corner - or probably just swap between polar and behind cams with P and B.",
        arcraft: "Design augmented reality experiences!",
        chat: "Catch up with your buds!"
	},
	general: {
		navigation: "Use the W, A, S, and D keys to move your avatar. Rotate with Z and C. Press SPACE to jump. Hold SHIFT to run. Press ENTER or X to enter a portal. Move your arms and legs with OPEN_BRACKET and CLOSE_BRACKET and SEMICOLON and QUOTE.",
		cameras: "Use the camera menu at the top of the page to switch between polar, pov, behind, front, and numbered room cameras. The arrow keys (as well as QERF) either (for default polar cam) rotate the camera around your character, or cycle between room cameras, or (for pov, behind, and front cameras) gently tilt your avatar's neck, thereby moving the camera. Zoom with PERIOD (or T) and COMMA (or G) keys. You can also drag your mouse to pan and use your mousewheel (or double-finger scroll) to zoom. Most players find navigation to be easiest with the (default) polar or behind cameras, which can be activated with the P and B buttons.",
